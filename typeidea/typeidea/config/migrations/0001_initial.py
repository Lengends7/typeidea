# -*- coding: utf-8 -*-
# Generated by Django 1.11.29 on 2022-10-28 12:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(max_length=50, verbose_name='标题')),
                ('displat_type', models.PositiveIntegerField(choices=[(2, '最新文章'), (1, 'HEML'), (4, '最近评论'), (3, '最热文章')], default=1, verbose_name='展示类型')),
